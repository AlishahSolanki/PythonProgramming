'''
Grading Rubric: 18.5 points total (6.5 points in LabExam3BMOD_Tu.py)
...
import LabExam3BMOD_Tu

# EUID

real_estate = {'Park Avenue': 325999, 'Lawther Drive': 692848}
...
price_list = LabExam3BMOD_Tu.home_prices(number)
